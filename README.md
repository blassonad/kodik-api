...
| `thiserror` | Декларативный публичный тип `Error` с сохранением вложенных исходных ошибок. |

## Установка

После публикации добавьте dependency из crates.io; минимальная поддерживаемая версия Rust (MSRV) — **1.97.1**.
